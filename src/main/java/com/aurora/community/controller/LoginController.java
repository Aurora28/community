...
public class LoginController implements CommunityConstant{
    ...
    public String register(Model model, User user) {
        ...
        if (map == null || map.isEmpty()) {
            model.addAttribute("msg", "registe successful! We sent an email to your mailbox, please activate it");
    ...
    public String activation(Model model, @PathVariable("userId") int userId, @PathVariable("code") String code) {
        ...
        if (result == ACTIVATION_SUCCESS) {
            model.addAttribute("msg", "Now you can use your account to login!");
    ...
    public void getKaptcha(HttpServletResponse response, HttpSession session) {
        ...
        // add text to session as kaptcha
        ...
        try {
            ...
            logger.error("kaptcha response fail. " + e.getMessage());
        }
    ...
    public String login(String username, String password, String code, boolean rememberMe, 
        ...
        if (StringUtils.isBlank(kaptcha) || StringUtils.isBlank(code) || 
            !kaptcha.equalsIgnoreCase(code)) {
                model.addAttribute("codeMsg", "the kaptcha is wrong");
                return "/site/login";
        }
